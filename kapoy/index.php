...
<head>
    ...
    <title>Land Surveying Services Portal - Professional Surveying Solutions</title>
    ...
    <div class="nav-container">
        <div class="nav-brand">
            ...
            <div class="brand-text">
                <span class="brand-name">GeoSurvey</span>
    ...
    <div class="container">
        ...
        <div class="services-grid">
            <div class="service-card" data-aos="fade-up">
                ...
                <p>Precise determination of property boundaries and corners for legal documentation and title transfer.</p>
                <div class="service-price">Starting at <strong>₱5,000</strong></div>
            ...
            <div class="service-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <p>Detailed mapping of terrain features, elevations, and contours for development planning.</p>
                <div class="service-price">Starting at <strong>₱8,000</strong></div>
                <a href="auth/register.php" class="service-link">Book Now <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="service-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <p>Accurate staking of building positions, grades, and alignments for construction projects.</p>
                <div class="service-price">Starting at <strong>₱6,000</strong></div>
                <a href="auth/register.php" class="service-link">Book Now <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="service-card" data-aos="fade-up" data-aos-delay="300">
                ...
                <p>Professional division of land into smaller parcels for residential and commercial development.</p>
                <div class="service-price">Starting at <strong>₱15,000</strong></div>
                <a href="auth/register.php" class="service-link">Book Now <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="service-card" data-aos="fade-up" data-aos-delay="400">
                ...
                <p>Large-scale precise measurements using GPS and advanced geodetic instruments.</p>
                <div class="service-price">Starting at <strong>₱25,000</strong></div>
                <a href="auth/register.php" class="service-link">Book Now <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="service-card" data-aos="fade-up" data-aos-delay="500">
                <div class="service-icon" style="background: linear-gradient(135deg, #a18cd1, #fbc2eb);">
                    <i class="fas fa-water"></i>
                </div>
                <h3>Hydrographic Survey</h3>
                <p>Specialized mapping of underwater terrain and water bodies for marine projects.</p>
                <div class="service-price">Starting at <strong>₱20,000</strong></div>
                <a href="auth/register.php" class="service-link">Book Now <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
...
<section class="engineers-section" id="engineers">
    <div class="container">
        <div class="section-header">
            ...
            <p>Licensed geodetic engineers with years of field experience</p>
        </div>
        <div class="engineers-grid">
            <div class="engineer-card">
                <div class="engineer-photo">
                    <img src="assets/images/engineer1.jpg" alt="Engr. Maria Santos" onerror="this.src='assets/images/default_avatar.png'">
                    <div class="availability-badge available">Available</div>
                </div>
                <div class="engineer-info">
                    <h3>Engr. Maria Santos</h3>
                    <p class="specialization">Boundary & Topographic Survey</p>
                    <div class="rating">
                        <div class="stars">★★★★★</div>
                        <span>4.8 (45 reviews)</span>
                    </div>
                    <div class="engineer-meta">
                        <span><i class="fas fa-briefcase"></i> 10 years exp.</span>
                        <span><i class="fas fa-building"></i> GeoTech Inc.</span>
                    </div>
                </div>
            ...
            <div class="engineer-card">
                <div class="engineer-photo">
                    <img src="assets/images/engineer2.jpg" alt="Engr. Roberto Cruz" onerror="this.src='assets/images/default_avatar.png'">
                    <div class="availability-badge available">Available</div>
                </div>
                <div class="engineer-info">
                    <h3>Engr. Roberto Cruz</h3>
                    <p class="specialization">Geodetic & Route Survey</p>
                    <div class="rating">
                        <div class="stars">★★★★★</div>
                        <span>4.9 (62 reviews)</span>
                    </div>
                    <div class="engineer-meta">
                        <span><i class="fas fa-briefcase"></i> 12 years exp.</span>
                        <span><i class="fas fa-building"></i> PrecisionMap</span>
                    </div>
                </div>
                <a href="auth/register.php" class="btn-book">Book Now</a>
            </div>
            <div class="engineer-card">
                <div class="engineer-photo">
                    <img src="assets/images/engineer4.jpg" alt="Engr. Mark Villanueva" onerror="this.src='assets/images/default_avatar.png'">
                    <div class="availability-badge available">Available</div>
                </div>
                <div class="engineer-info">
                    <h3>Engr. Mark Villanueva</h3>
                    <p class="specialization">Drone & Topographic Survey</p>
                    <div class="rating">
                        <div class="stars">★★★★★</div>
                        <span>4.85 (29 reviews)</span>
                    </div>
                    <div class="engineer-meta">
                        <span><i class="fas fa-briefcase"></i> 6 years exp.</span>
                        <span><i class="fas fa-building"></i> LandMark Co.</span>
                    </div>
                </div>
                <a href="auth/register.php" class="btn-book">Book Now</a>
            </div>
            ...
            <div class="testimonial-card">
                ...
                <div class="testimonial-author">
                    ...
                    <div>
                        ...
                        <span>Property Owner, Manila</span>
                    </div>
                    <div class="stars">★★★★★</div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="about-grid">
            <div class="about-content">
                ...
                <p>GeoSurvey Portal connects property owners, developers, and contractors with PRC-licensed geodetic engineers across the Philippines. We make professional land surveying accessible, transparent, and hassle-free.</p>
                <div class="about-stats-row">
                    <div class="about-stat">
                        <span class="about-stat-num">10+</span>
                        <span class="about-stat-lbl">Years in Service</span>
                    </div>
                    <div class="about-stat">
                        <span class="about-stat-num">500+</span>
                        <span class="about-stat-lbl">Projects Completed</span>
                    </div>
                    <div class="about-stat">
                        <span class="about-stat-num">50+</span>
                        <span class="about-stat-lbl">Licensed Engineers</span>
                    </div>
                </div>
                <div class="about-features">
                    <div class="about-feature-item">
                        ...
                        <div>
                            <strong>PRC Licensed & Verified</strong>
                            <p>Every engineer on our platform is verified with a valid PRC license.</p>
                        </div>
                    </div>
                    <div class="about-feature-item">
                        ...
                        <div>
                            ...
                            <p>Book same-week appointments and receive results on time, every time.</p>
                        </div>
                    </div>
                    <div class="about-feature-item">
                        ...
                        <div>
                            ...
                            <p>Engineers available across Metro Manila, Visayas, and Mindanao.</p>
                        </div>
                    </div>
                    <div class="about-feature-item">
                        ...
                        <div>
                            ...
                            <p>Our AI assistant is always available to answer your questions.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="about-visual">
                <div class="about-card-stack">
                    <div class="about-card about-card-1">
                        ...
                        <strong>Boundary Survey</strong>
                        <span>Completed in 3–5 days</span>
                    </div>
...
<section class="cta-section">
    <div class="container">
        <div class="cta-content">
            ...
            <p>Join hundreds of satisfied clients who trust our platform for their land surveying needs.</p>
    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-links">
                <h4>Services</h4>
                <ul>
                    <li><a href="#">Boundary Survey</a></li>
                    <li><a href="#">Topographic Survey</a></li>
                    <li><a href="#">Construction Layout</a></li>
                    <li><a href="#">Subdivision Survey</a></li>
            ...
            <div class="footer-contact">
                ...
                <div class="contact-item">
                    ...
                    <span>123 Survey St., Makati City, Metro Manila</span>
                </div>
                <div class="contact-item">
                ...
                <div class="contact-item">
                    ...
                    <span>info@geosurveyportal.ph</span>
                </div>
                <div class="contact-item">
...
<div class="chatbot-widget" id="chatbotWidget">
    ...
    <div class="chatbot-widget-messages" id="chatbotWidgetMessages">
        <div class="chatbot-message bot">
            ...
            <div class="chatbot-msg-bubble">
                <p>Hello! 👋 I'm GeoBot, your AI assistant. How can I help you with your land surveying needs today?</p>
    ...
    <div class="chatbot-widget-input">
        <input type="text" id="chatbotWidgetInput" placeholder="Type your message..." autocomplete="off">
